...
/**
 * Implementacion de IntList que utiliza un array que dobla su tamano cuando se llena.
 */
public class IntVector implements IntList {
    private static final int DEFAULT_SIZE = 20; // Tamano inicial del array por defecto.
    ...
    public void add(int number) {
        ...
        if (size == data.length) {
            ...
            // Calcula el nuevo tamano del array (el doble del tamano actual).
